<script lang="ts">
	...
	interface Props {
		...
		/** Opens the gallery upgrade shop overlay. Optional so existing call sites keep compiling. */
		onopengalleryupgrades?: () => void;
		notice?: Snippet;
	}
