...
const API_BASE = '/api/modifier-explorer';
export const OUTPUT_BASE = '/modifier-explorer-output';
...
/** Persist which prompt-tags the user marked as good on this image. */
...
/** Draw an object URL to PNG bytes for disk persistence. */
